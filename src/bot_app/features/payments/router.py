"""Payments router — pre_checkout_query + successful_payment handlers.

These handlers implement the Telegram Payments API lifecycle:
...
Both handlers are **outside** the checkout FSM — Telegram sends them as
standalone updates regardless of FSM state.

Callback-data schema: N/A (no inline keyboards in this router).
"""
